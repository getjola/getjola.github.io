...
xhttp.open("GET", `http://localhost/user?email=${email}&sessid=${sessid}`, true);
xhttp.send();
...
function interested() {
   ...
   if (interests.length <= 1) {
       ...
       xhttp.open("GET", `http://localhost/setInterests?email=${email}&sessid=${sessid}&interests=${interests}`, true);
       xhttp.send();
   }
}